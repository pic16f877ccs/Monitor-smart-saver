...
EXTENSION='monitorSmartSaver@pic16f877ccs.github.com'
EXTENSIONNAME='monitor-smart-saver'
...
build() {
    ...
    SCHEMA='./../../assets/org.gnome.shell.extensions.monitor-smart-saver.gschema.xml'
    PODIR='./../../assets/locale'
